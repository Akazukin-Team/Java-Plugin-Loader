...
import org.akazukin.loader.api.event.events.IPreBatchPluginUnregisterEvent;
...
@Getter
@Setter
public final class PreBatchPluginUnregisterEvent implements IPreBatchPluginUnregisterEvent {
    final String[] pluginIds;
    final IPluginContext[] pluginContexts;
    boolean cancelled;

    public PreBatchPluginUnregisterEvent(final @NotNull IPluginContext[] pluginContexts) {
    ...
    public String toString() {
        return "PreBatchPluginUnregisterEvent{"

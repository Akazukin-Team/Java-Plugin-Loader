...
import org.akazukin.loader.api.event.events.IPostBatchPluginEnableEvent;
...
@Getter
public final class PostBatchPluginEnableEvent implements IPostBatchPluginEnableEvent {
    String[] pluginIds;
    IPluginContext[] pluginContexts;

    public PostBatchPluginEnableEvent(final @NotNull IPluginContext[] pluginContexts) {
    ...
    public String toString() {
        return "PostBatchPluginEnableEvent{"
